...
import { isSupabaseConfigured, listCases } from "@/lib/atlas/cases";
import { pipelineCards } from "@/lib/atlas/sample-data";
import { getStatePacks, summarizePack } from "@/lib/atlas/state-packs";
import { listBorrowerIntroCallRequests } from "@/lib/atlas/borrower-intro-requests";
import { getCaseDealProfile } from "@/lib/atlas/deal-intake";
import { getBorrowerPortalByCaseId, getExecutionReadiness } from "@/lib/atlas/intake";
import { withBasePath } from "@/lib/atlas/runtime";
import type { CaseRecord } from "@/lib/atlas/types";
...
export async function TuricumReviewOverview() {
  ...
  return (
    <main>
      <div className="shell">
        <section className="hero atlas-review-hero">
          <div className="hero-grid">
            <div className="hero-copy">
              ...
              <div className="atlas-review-rail">
              ...
              <div className="form-actions atlas-review-quick-actions">
            ...
            <div className="hero-aside atlas-review-aside">
              <p className="eyebrow">Platform snapshot</p>
              <div className="dashboard-band">
                <div className="band-card atlas-review-band-card">
        ...
        <section className="panel atlas-review-panel atlas-team-queue-panel">
          ...
          <div className="status-grid atlas-team-queue-grid">
            <article className="status-card atlas-review-card atlas-team-queue-card">
        ...
        <section className="panel atlas-blocker-strip">
          <div className="section-head">
            <div>
          ...
          <div className="status-grid">
            {blockers.length === 0 ? (
              <article className="atlas-blocker-card tone-info">
              ...
              blockers.map(({ caseItem, label, detail, tone }) => (
                <article key={caseItem.id} className={`atlas-blocker-card tone-${tone}`}>
                  <div className="section-head">
                    <div>
        ...
        <section className="two-up">
          <div className="panel lead atlas-review-panel">
            <div className="section-head">
              <div>
            ...
            <div className="status-grid">
              {teamLanes.map((lane) => (
                <article key={lane.title} className="status-card atlas-review-card">
          ...
          <div className="panel atlas-review-panel atlas-review-rule-panel">
            <div className="section-head">
              <div>
            ...
            <ul className="list atlas-review-list">
        ...
        <section className="panel atlas-review-panel">
          <div className="section-head">
            <div>
          ...
          <div className="three-up">
            <div className="metric atlas-review-metric">
              <h3>1. Intake</h3>
          ...
          <div className="panel lead atlas-review-panel">
            ...
            <div className="status-grid">
              {reviewSurfaces.map((surface) => (
                <article key={surface.title} className="status-card atlas-review-card">
        ...
        <section className="two-up">
          <div className="panel atlas-review-panel">
            <div className="section-head">
              <div>
            ...
            <div className="status-grid">
              {featuredCases.length === 0 ? (
                <article className="status-card atlas-review-card">
                ...
                featuredCases.map((caseItem) => (
                  <article key={caseItem.id} className="status-card atlas-review-card">
                    <p className="eyebrow">{caseItem.code}</p>
          ...
          <div className="panel atlas-review-panel">
            ...
            <div className="status-grid">
              {summary.map((statePack) => (
                <article key={statePack.state} className="status-card atlas-review-card">
                  <div className="section-head">
                    <div>
        ...
        <section className="two-up">
          <div className="panel lead atlas-review-panel">
            ...
            <div className="three-up">
              {pipelineCards.map((card) => (
                <div key={card.title} className="metric atlas-review-metric">
                  <h3>{card.title}</h3>
                  <p>{card.summary}</p>
                </div>
              ))}
          ...
          <div className="callout atlas-review-callout">
