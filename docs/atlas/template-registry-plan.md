# Atlas Template Registry Plan

## Goal

Atlas should treat the extracted legal corpus as a structured library, not a loose file dump.
...
The extracted corpus already shows repeating document families across states and structures. If Atlas stores only file names, the library will become hard to search and hard to reuse.
...
These have the strongest document coverage and will give Atlas a usable starting library.
