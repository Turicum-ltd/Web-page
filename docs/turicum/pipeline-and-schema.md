# Turicum Pipeline And Schema

## Product Shape

Turicum v1 is a lean operating platform for:
...
Turicum should assemble the case packet using:
...
Turicum should keep each document typed by:
...
Even if Turicum stores files in Supabase Storage or S3, the UI should mirror the real-world folder model:
