# Turicum State-Pack Matrix

## Goal

Turicum should use a configurable `state-pack` model:
...
Turicum v1 should support these structures:
...
- whether `purchase` in Turicum maps to `SLB`, `option`, or both in each state
